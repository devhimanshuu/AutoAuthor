...
const Features = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-violet-50/50 via-transparent to-purple-50/50"></div>
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            ...
            return (
              ...
              >
                ...
                <div className="">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-violet-900 transition-colors duration-300">
                      {feature.title}
                    </h3>
        ...
        <div className="text-center mt-16">
          ...
          <a
            href="/signup"
            className="inline-flex items-center space-x-2 bg-gradient-to-br from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold  shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200"
          >
